...
<p className='sm:text-4xl  font-bold text-gray-600'>{ OverViewData.gigs_title}</p>

<div style={{alignItems:"center"}} className='sm:flex justify-between'>

<div style={{ alignItems: "center" }} className="sm:flex p-1 mt-5 ">
        <Image className="rounded-full w-[65px] h-[65px]" src={profileImages} width={200} height={100} alt="" />

        <div>
          <span className="mx-2  font-semibold text-gray-700">{profileName}</span>
            <span>({Email})</span>
          <div className="flex">
...
<div className='sm:me-16 sm:mt-5'>
    <span className='mx-1 bg-sky-500 text-white p-1'>Completed Order</span>
    <span className='p-1 border border-sky-500  font-bold text-black'>{order || 0}</span>
</div>
</div>
<hr className='my-5 border-2'></hr>


<p className='text-gray-700 text-xl font-semibold'>Here are some pictures showcasing her work and activities.</p>
...
<Swiper
   ...
   {gallary.map(p=><>
    <SwiperSlide>
        <Image className='sm:w-full' src={p} width={400} height={200} alt=''/>
    </SwiperSlide>
    </>)}
      </Swiper>
...
{/* ----------------details ------ */}
<p style={{alignItems:"center"}} className='flex font-bold text-2xl text-gray-800 sm:mx-1 my-2'>
...
<div className='mt-10'>
<p style={{alignItems:"center"}} className='sm:flex font-semibold text-gray-600 sm:text-xl my-2 sm:mx-1'>
  <FcFaq className='me-1'/> Better understand the seller by answering this question
  
  <span className='font-bold text-black mx-1 text-2xl '> -(FAQ)</span>
...
<div className='sm:w-full p-2 mb-20'>
{
  ...
  <div className="collapse-title text-xl font-medium">
   <span className='me-2 font-bold '>Question:</span> {p.Question}
  </div>
...
<div>
 <p className='text-xl font-semibold  text-gray-700 border sm:w-4/12 text-center  px-5 py-2'>About the seller</p> 
...
<div className=' px-5 py-3 border   border-gray-200 sm:grid grid-cols-2 gap-x-3 gap-y-5'>
  ...
  <div>
    ...
    <p className='text-green-700 font-semibold'>{personal_Information?.country}</p>
  </div>

  <div>
    <p className='font-semibold text-gray-600 text-xl'>Avg. response time</p>
    <p  className='text-green-700 font-semibold'>{professional?.spend_Time}</p>
  </div>

  <div>
    <p className='font-semibold text-gray-600 text-xl'>Languages</p>
    <p  className='text-green-700 font-semibold'>{personal_Information?.Language}</p>
  </div>

  <div>
    <p className='font-semibold text-gray-600 text-xl'>Member since</p>
    <p  className='text-green-700 font-semibold'>{personal_Information?.member_since}</p>
  </div>
</div>
</div>


<div style={{alignItems:"center"}} className='mt-10 sm:flex gap-x-3 mx-2'>
...
<div className='sm:flex mt-5 sm:mt-0'>
{
  ...
  <span className='mx-1 sm:mx-2 border  text-white rounded-md bg-[#8062D6] p-2'>{p}</span>
...
<p className='font-semibold text-xl mt-16 text-gray-700'>Below are individual reviews:</p>
...
<div>
      <Image className="rounded-full w-[50px] h-[50px]" src={p.profilePicture} width={200} height={100} alt="" />
      </div>

        <div className='sm:ms-3  sm:w-8/12'>
          <span className="mx-2  font-semibold text-gray-700">{p.profileName}</span>

          <div className="flex">
            <ReactStars classNames="ms-2" size="1rem" value={p.review_rating} activeColor="#FF9B50" />
            <span className="text-gray-500">({ratingData || 0})</span>
 
          </div>
          <p className='sm:ms-2 text-gray-600 font-semibold'>({p.country_name})</p>
...
<p className='ms-auto text-gray-700'>Date: <span className=''>{p.review_date}</span></p>
